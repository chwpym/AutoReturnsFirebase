  ...
  return (
    <button
      ...
      className={cn(
        ...
        "[[data-side=left][data-state=collapsed][data-collapsible=offcanvas]_&]:-right-2",
        "[[data-side=right][data-state=collapsed][data-collapsible=offcanvas]_&]:-left-2",
        className
      )}
      {...props}
    />
